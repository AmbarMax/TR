...
namespace App\Web3\Packages\EthereumTx;

use App\Web3\Packages\EthereumUtil\Util;
use App\Web3\Packages\rlp\RLP;
...
class Transaction implements ArrayAccess
{
     ...
     * 
     * @return string serialized ethereum transaction
     */
