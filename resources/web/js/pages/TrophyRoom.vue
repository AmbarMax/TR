...
export default {
  ...
  data() {
    return {
      ...
      // GitHub stays inline alongside the shared icon constants — see
      // /constants/platform-icons.js. Icon SVGs default to 14x14; the
      // .ph-icon wrapper sizes them up to 24px via CSS.
      platformConfig: {
        ...PLATFORM_ICONS,
        github: {
          name: 'GitHub',
