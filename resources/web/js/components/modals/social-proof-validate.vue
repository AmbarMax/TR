    ...
    <div class="modal_background" @click.self="closeCreateAchievement">
        <div class="modal_window">
          ...
          <h4 v-if="!users" class="modal_label">
            ...
            <button-white
                @click="validateAchivement()" :disabled="!selectedUser.length || button_is_locked" :text="'Request runes'" class="validate_achievement_social_proof"></button-white>
        </div>
    </div>
</template>
    ...
    methods: {
        ...
        validateAchivement(){
            if (this.selectedUser.length !== 0){
                ...
                store.state.modals.createAchievement.data.proof = 1;
