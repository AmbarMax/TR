        ...
        <ul class="sidebar_menu">
            ...
            <li>
                <router-link to="/my-chests" :class="{ active_item: $route.path === '/my-chests' }">
                    <svg v-if="$route.path === '/my-chests'" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
