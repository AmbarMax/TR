<div class="modal show new-chest-modal fade" id="edit-chest-modal">
    <div class="modal-dialog modal-lg modal-simple">
        <div class="modal-content p-2 p-md-2">
            ...
            <div class="modal-body">
                <form action="{{route('admin.chests.update', ['id' => 0])}}" method="POST" id="edit-chest-form"
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="form-group" id="chest-image">
                            <div class="d-flex justify-content-center mt-1 mb-1 js-chest-image">
                                ...
                                <img style="display: block" id="image" class="chest chest-closed image-selected-closed chest-image" alt="">
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="form-group" id="chest-image">
                            <div class="d-flex justify-content-center mt-1 mb-1 js-chest-image">
                                {{--<div class="chest-image-alt"></div>--}}
                                <img style="display: block" id="image" class="chest chest-opened image-selected-opened chest-image" alt="">
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <select id="fp-role-picker-key-status" class="js-create-key-select" required name="key">
                    ...
                    <div class="col-6 mb-2 col-md-6">
                        ...
                        <input
                            type="text"
                            id="fp-expiration-date-at-picker-edit"
                    ...
                    <div class="col-12 mb-2 fv-plugins-icon-container">
                        ...
                        <select id="fp-role-picker-chest-status" class="js-create-chest-select" required name="items[]">
                            <option value="" disabled selected>Select Items</option>
